...
private:
    ...
    ResultVal<Kernel::KEvent*> Initialize(u32 sharedmem_size, const NodeInfo& node, u16 version,
                                          Kernel::KSharedMemory* sharedmem);
...
private:
    ...
    Kernel::KEvent* connection_status_event;

    // Shared memory provided by the application to store the receive buffer.
    // This is not currently used.
    Kernel::KSharedMemory* recv_buffer_memory;
    ...
    struct BindNodeData {
        ...
        Kernel::KEvent* event;                        ///< Receive event for this bind node.
