...
Common::Vec4<u8> RasterizerSoftware::WriteTevConfig(
    ...
    for (u32 tev_stage_index = 0; tev_stage_index < tev_stages.size(); ++tev_stage_index) {
        ...
        const std::array<Common::Vec3<u8>, 3> color_result = {
            GetColorModifier(
                tev_stage.color_modifier1,
                get_source(force_source3 ? tev_stage.color_source3 : tev_stage.color_source1)),
            GetColorModifier(
                tev_stage.color_modifier2,
                get_source(force_source3 ? tev_stage.color_source3 : tev_stage.color_source2)),
